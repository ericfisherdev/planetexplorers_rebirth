...
public class CSUI_Personnel : MonoBehaviour
{
    ...
    public void RemovePersonnel(CSPersonnel npc)
    {
        ...
        if (index != -1)
        {
            ...
            //lz-2016.08.29 ɾ����Ҫˢ�µ�ǰӦ����ʾ�ķ�Χ��������滹�м��Ż����յ����
            GridRange();

            //lz-2016.08.29 ��дɾ��һ��npc��ѡ��ת�Ʒ���
            if (oldIsChecked)
            {
                if (npc_grids_list.Count > 0)
                {
                    ...
                    //1.ɾ��һ��npc������index�ᱻ���������������ڲ�û�г�����ʾ��Χ��ѡ������ģ������Ļ���������������С
                    int newIndex = 0;
                    //lz-2016.10.23 ���� #5077 ����Խ��
    ...
    void GridRange()
    {
        ...
        for (int i = mGridPageIndex * NPC_GRID_COUNT; i < npc_grids_list.Count; i++)
        {
            ...
            //lz-2016.07.05 ��ҳ��ʱ�������һҳ�б�ѡ�е�grid���Ͱ����������Ϊѡ��״̬

...
public class UIMinMapCtrl : UIStaticWnd
{
    ...
    Dictionary<int, List<MissionLabel>> npc_receiveSubmit = new Dictionary<int, List<MissionLabel>>();  //�����ʾ��С��ͼ�ϵ���ʾ���ȼ�
    enum ReceiveSubmit
    {
        nothing = 0,
        receive = 1,
    ...
    void MinMapMissionLabelRealation(MissionLabel tmp,bool add)             //С��ͼ��ʾ�����ʾ�����ȼ���ϵ
    {
        if (add)
        {
    ...
    void UpdateCurAllLabelShow()
    {
        ...
        for (int i = 0; i < this.m_CurrentMapLabelList.Count; i++)
        {
            ...
            if (null != mapLabel &&null!=mapLabel._ILabel)
            {
                ...
                //lz-2016.06.15 npc����������Ż����ʹӾͲ���ʾС��ͼ�������ͼ��
                if(mapLabel.type== ELabelType.Mission)
                {
                    ...
                    //lz-2016.10.12 ������return��return�����ѭ�������º����Label���������������
    ...
    /// <summary>lz-2016.11.03 ��ʾ���С��ͼ��Tutorial</summary>
    public void ShowMapTutorial()
    {
        if (PeGameMgr.IsTutorial)
        {
            //lz-2016.11.07 ����ʾ��ʱ�����С��ͼ�����ţ��͵�����
            if (m_MinMapIsHide)
    ...
    /// <summary>lz-2016.11.03 ��ʾ����׷�ٰ�ť��Tutorial</summary>
    public void ShowMissionTrackTutorial()
    {
        if (PeGameMgr.IsTutorial)
        {
            ...
            go.transform.localScale = Vector3.one;
            go.transform.localRotation = Quaternion.identity;
            //lz-2016.11.07 ����׷��Tutorial��ʾ������ʱ����ʾ�Ի����ݰ�ť��Tutorial
            go.GetComponent<UIWndTutorialTip_N>().DeleteEvent = ShowConversationsBtnTutorial;
        }
    }

    /// <summary>lz-2016.11.03 ��ʾ�Ի����ݰ�ť��Tutorial</summary>

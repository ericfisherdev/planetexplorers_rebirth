...
public class NpcOverHead : MonoBehaviour
{
    ...
    void Awake()
    {
        //lz-2016.06.07 ̫�˷��ˣ�������Ԥ�����壬Ϊʲô����Ԥ�������ϰ�Ҫ�õ�����������ã���Ҫʵ��һ��NpcOverHead��ͨ��GetComponent��FindChild������ֵ��
        //InitOverHead();
    }
    ...
    {
        if (mSpeakSentenseList.Count > 0)//��ǰ������һ�仰
        {

...
public class VCEStatusBar : MonoBehaviour
{
	private static VCEStatusBar s_Instance = null;
	public static VCEStatusBar Instance { get { return s_Instance; } }

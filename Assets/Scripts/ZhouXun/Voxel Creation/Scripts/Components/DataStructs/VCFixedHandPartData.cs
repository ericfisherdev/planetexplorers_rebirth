...
public class VCFixedHandPartData : VCPartData, IVCMultiphaseComponentData
{

    public bool m_LeftHand = true;
    public int Phase { get { return m_LeftHand ? 1 : 0; } set { m_LeftHand = (value == 1); } }
